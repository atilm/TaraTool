...
| M   | Moderate  | Low availability of the item or component. Limited physical and/or logical access. Physical access to the system or component without using any special tools. Example: Attacker is able to get access to the system and its exposed physical interface, e.g., physical access via USB.                                                          | 4     |
